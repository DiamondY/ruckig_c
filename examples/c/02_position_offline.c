...
int main(void) {
    ...
    ruckig_trajectory_at_time(trajectory, ruckig_trajectory_get_duration(trajectory) / 2.0, position, velocity, acceleration, NULL, NULL);
    printf("duration %.6f midpoint %.6f %.6f %.6f\n",
