...
- [x] Linux performance benchmark result is recorded in `docs/release/evidence/performance_report.md`.
...
- Linux performance result is recorded in `docs/release/evidence/performance_report.md`.
...
`linux-performance.txt`. Copy that output into `docs/release/evidence/performance_report.md`
before tagging.

## Release Notes

Use `docs/release/notes/0.1.0.md` as the base text for the GitHub Release.
