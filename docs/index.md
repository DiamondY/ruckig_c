...
- `release/checklists/` - release checklists by version.
  ...
  default CI.
  `release/checklists/post-v0.16.0-manual-analysis-evidence-policy.md`
  records touched-file manual static-analysis evidence guidance without a
  default CI gate.
  ...
  `release/checklists/post-v0.16.0-private-derived-count-hardening.md`
  records private tracking, waypoint, and trajectory derived-count hardening.
