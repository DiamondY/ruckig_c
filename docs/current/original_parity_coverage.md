...
| Full original repository/product parity | 72-77% | Core runtime is strong; bounded Optimized tracking is stable and being deepened on `0.7.0-alpha.2`, while formal bindings, package distribution, Pro/cloud equivalence, and C++ ergonomics remain gaps. |
...
deterministic stress, but it is not a stable release and does not create formal
Pro/cloud equivalence.
