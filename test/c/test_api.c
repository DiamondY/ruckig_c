...
static void test_tracking_sequence_fast_continuation_delta_time_contract(void) {
    ruckig_tracking_t* tracking = NULL;
...
static void configure_tracking_sequence_optimized_continuation(
    ruckig_tracking_t* tracking,
    size_t lookahead_count,
    size_t max_candidates
) {
...
static void run_tracking_sequence_optimized_continuation_equivalence_case(
    ruckig_tracking_optimized_strategy_t strategy,
    size_t dofs,
    size_t count,
    size_t lookahead_count,
